...
# --- Main Application UI ---
st.title("Carbon Dioxide ($CO_2$) Emissions Estimation in China")
...
if st.session_state.page == "Home":
    ...
    with home_tab1:
        ...
        st.markdown("""
        This application provides two advanced tools for analyzing and predicting Carbon Dioxide ($CO_2$) emissions across various provinces in China. 
